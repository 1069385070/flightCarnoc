            ...
            <form id="search_form" action="">
                <div class="search_style">
                    <ul class="search_content clearfix">
                        ...
                        <li>
                            <%--<shiro:authenticated>--%>
                                <shiro:hasPermission name="Flight-dynamics:select">
                                    <button type="button" class="btn_search" onclick="search_flight()"><i class="icon-search"  ></i>查询</button>
                                </shiro:hasPermission>
                                <shiro:lacksPermission name="Flight-dynamics:select">
                                    <button type="button" class="btn_search" onclick="search_flight()" disabled><i class="icon-search"  ></i>查询</button>
                                    ...
                                    success: function(data){
                                        ...
                                        $.each(jsonObectData, function(commentIndex, comment){
                                            html +=' <tr>\n' +
                                                ...
                                                '<td>'+comment.airportEnd+'</td>\n' +
                                                '<td class="td-status"><span class="label label-success radius">'+comment.flightStatus+'</span></td>\n' +
                                                '<td class="td-manage"><shiro:hasPermission name='Flight-dynamics:update'><a title="编辑" onclick="member_edit('+comment.id+')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a></shiro:hasPermission><shiro:lacksPermission name='Flight-dynamics:update'><a title="编辑" onclick="member_edit('+comment.id+')" href="javascript:;"  class="btn btn-xs btn-info" ><i class="icon-edit bigger-120"></i></a></shiro:lacksPermission></td>\n' +
                                                '</tr>';
                                        });
                                        $('#context').html(html);
                                    }
