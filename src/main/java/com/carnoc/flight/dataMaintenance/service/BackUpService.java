package com.carnoc.flight.dataMaintenance.service;
...
public interface BackUpService {
    ...
    /*<delete id="restoreMysql" parameterType="com.carnoc.flight.dataMaintenance.pojo.BackUp">
    delete from f_backup where id=#{id}
    </delete>*/
